...
zinit wait as"null" lucid from"gh-r" for \
      atload"alias ls='eza --color=auto --group-directories-first'; alias la='ls -laFh'" cp"**/exa.1 -> $ZPFX/share/man/man1" mv"completions/exa.zsh -> _exa" completions sbin"**/eza" if'[[ $CPUTYPE != aarch* ]] && (( $+commands[unzip] ))' eza-community/eza \
