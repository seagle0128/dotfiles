...
alias upgrade_emacs='emacs -Q --batch -L "$HOME/.emacs.d/lisp/" -l "init-package.el" -l "init-funcs.el" --eval "(setq paradox-execute-asynchronously nil)" --eval "(package-refresh-contents)" --eval "(update-config-and-packages)"'
